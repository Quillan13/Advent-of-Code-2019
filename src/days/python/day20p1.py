...
def main():
    ...
    while queue:
        ...
        if current_position[0] > 0 and f[current_position[1]][current_position[0] - 1] == ".":
            queue.append(
                ((current_position[0] - 1, current_position[1]), current_steps + 1))
        ...
        if current_position[1] > 0 and f[current_position[1] - 1][current_position[0]] == ".":
            queue.append(
                ((current_position[0], current_position[1] - 1), current_steps + 1))
        ...
        if current_position in portal_locations and portal_locations[current_position] != "AA":
            queue.append((get_other_portal(portals, current_position,
                                           portal_locations[current_position]), current_steps + 1))
